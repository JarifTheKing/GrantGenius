...
//   // 🔹 get logged-in user email (adjust if you store user differently)
...
//   useEffect(() => {
//     if (userEmail) {
//       fetch(`http://localhost:3000/my-applications?email=${userEmail}`)
//         .then((res) => res.json())
...
//     (item) => item.scholarshipId === scholarshipData._id
//   );
...
//     axiosSecure
//       .get(`/my-applications?email=${userEmail}`)
//       .then((res) => {
