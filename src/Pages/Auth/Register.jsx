...
const Register = () => {
  ...
  // get previous page OR go to home
  ...
  const handleRegister = (data) => {
    ...
    registerUser(email, password, name, null)
      .then((res) => {
  ...
  const handleGoogleSignIn = () => {
    signInWithGoogle()
      .then((res) => {
        ...
        navigate(from, { replace: true }); // 🔥 redirect on Google login too
      })
              ...
              <div>
                ...
                {errors.password && (
                  <p className="text-red-500 text-sm mt-1">
                    Password must include uppercase, lowercase and be 6+ chars.
                  </p>
                )}
              </div>
